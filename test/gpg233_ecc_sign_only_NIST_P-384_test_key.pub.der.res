Old: Public Key Packet(tag 6)(111 bytes)
	Ver 4 - new
	Public key creation time - Mon Nov 29 09:34:56 UTC 2021
...
Old: User ID Packet(tag 13)(43 bytes)
	User ID -  (gpg233_ecc_sign_only_NIST_P-384_test_key)
Old: Signature Packet(tag 2)(179 bytes)
	...
	Hashed Sub: issuer fingerprint(sub 33)(21 bytes)
	 v4 -	Fingerprint - ab fb 32 25 34 ec ec ba d5 cc 9c 6f 80 f5 db 39 7d d1 d0 bb 
	Hashed Sub: signature creation time(sub 2)(4 bytes)
		Time - Mon Nov 29 09:34:56 UTC 2021
	...
	Hashed Sub: preferred encryption modes(sub 34)(2 bytes)
		AEAD alg - OCB(aead 2)
		AEAD alg - EAX(aead 1)
	...
	Sub: issuer key ID(sub 16)(8 bytes)
		Key ID - 0x80F5DB397DD1D0BB
	Hash left 2 bytes - 2a fe 
	ECDSA r(384 bits) - ...
	ECDSA s(384 bits) - ...
